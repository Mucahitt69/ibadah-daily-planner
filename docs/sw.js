...
const VERSION = 'ibadah-494cc2f9';   // v4 : ajout des fichiers de langue

const FICHIERS = [
  './',
  './index.html',
  './styles.css?v=494cc2f9',
  './textes.js?v=494cc2f9',
  './store.js?v=494cc2f9',
  './adhkar.js?v=494cc2f9',
  './hadith-secours-en.js?v=494cc2f9',
  './feuille.js?v=494cc2f9',
  './app.js?v=494cc2f9',
  './rappels.js?v=494cc2f9',
